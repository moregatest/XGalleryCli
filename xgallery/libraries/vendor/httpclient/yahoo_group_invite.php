...
if ($success)
{
	...
	{
		?>
		<h2 style="text-align: center">The user '<?php echo $yahoo->logged_user; ?>' has logged in Yahoo
			successfully.</h2>
		<?php
		if (IsSet($parameters['Invited']))
		{
			?>
			<h2 style="text-align: center"><?php echo $parameters['Invited']; ?> users were successfully invited to
				Yahoo group <?php echo $group; ?> .</h2>
			<?php
		}
	}
	else
